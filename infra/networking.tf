...
resource "aws_eip" "nat_a" {
  ...
  tags = merge(local.common_tags, {
    Name = "${local.project_name}-nat-eip-a"
  })
}
...
resource "aws_eip" "nat_b" {
  ...
  tags = merge(local.common_tags, {
    Name = "${local.project_name}-nat-eip-b"
  })
}
...
resource "aws_nat_gateway" "nat_a" {
  ...
  tags = merge(local.common_tags, {
    Name = "${local.project_name}-nat-gateway-a"
  })
...
resource "aws_nat_gateway" "nat_b" {
  ...
  tags = merge(local.common_tags, {
    Name = "${local.project_name}-nat-gateway-b"
  })
...
resource "aws_route_table" "private_a" {
  ...
  tags = merge(local.common_tags, {
    Name = "${local.project_name}-private-rt-a"
  })
}
...
resource "aws_route_table" "private_b" {
  ...
  tags = merge(local.common_tags, {
    Name = "${local.project_name}-private-rt-b"
  })
}
